...
* [Test Infra](./ansible/testinfra.md)
* [Vault](./ansible/vault.md)

### Arch Linux

* [Maximise battery life on Archlinux](./archlinux/archlinux-battery-life.md)
* [Install Archlinux on Slimbook](./archlinux/archlinux-on-slimbook.md)
* [Configure SSD on Archlinux for Slimbook](./archlinux/archlinux-ssd-configuration.md)
* [DNS en ArchLinux cuando usas OpenVpn](./archlinux/dns-openvpn.md)
* [Slimbook TouchPad](./archlinux/slimbook-touchpad.md)

### ElasticSearch

* [API Util](./elasticsearch/api-utils.md)
* [GCP cluster](./elasticsearch/gcp-cluster.md)
* [Monitoring](./elasticsearch/monitoring.md)

### FreeBSD
* [Disk](./freebsd/disk.md)
* [Nginx PHP Mysql](./freebsd/nginx-php-mysql.md)
* [Notes](./freebsd/notes.md)
* [Opensense Nextcloud](./freebsd/opensense-nextcloud.md)
* [VM](./freebsd/vm.md)
* [WiFi](./freebsd/wifi.md)

### Git
* [Change multiple authors](./git/change-multiple-authors.md)
* [Cheat sheet](./git/cheat-sheet.md)
* [Getting started](./git/getting-started.md)
* [Notes](./git/notes.md)

### GoLang
* [Learning resources](./golang/learning-resources.md)
* [Notes](./golang/notes.md)
* [The llitle Go book](./golang/the-little-go-book.md)

### Notes

* [AsciiDoc](./notes/asciidoc.md)
...
* [Load Test](./notes/load-test.md)
* [Mikrotik](./notes/mikrotik.md)
* [Pass](./notes/pass.md)
